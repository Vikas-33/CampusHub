...
urlpatterns = [
    ...
    path('attendance/smart/<int:course_id>/', views.smart_attendance, name='smart_attendance'),
    ...
    path('exams/<int:exam_id>/postpone/', views.postpone_exam, name='postpone_exam'),
